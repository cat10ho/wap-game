...
function gameLoop(currentTime) {
  ...
  if (!gameover && !waitingToStart) {
    ...
    itemController.update(gameSpeed, deltaTime, score.currentStage);//여ㅣ 여기서 아이템 생성함. 존나 보물찾기네.
    // 달리기
  ...
  if (!gameover && cactiController.collideWith(player)) {
    gameover = true;
    sendEvent(3,{currentStage: score.currentStage,timestamp: Date.now(), getItemId: score.getItemId , score: score.score})
    setupGameReset();
  }
